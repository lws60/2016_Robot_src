 ...
 *
 */
public class Flashlight2 extends Subsystem implements LogDataSource {
    ...
    public Flashlight2()
    {
    	m_flashlightRelay = new Relay ( RobotMap.FLASHLIGHT2_CHANNEL, RobotMap.FLASHLIGHT_DIRECTION );
    }
